...
polish_name: Podgrzybnica ceglasta
source: https://pl.wikipedia.org/wiki/Podgrzybnica_ceglasta
---
# Podgrzybnica ceglasta 
# hypomyces lateritius 

Podgrzybnica ceglasta (Hypomyces lateritius (Fr.) Tul. & C. Tul.) – gatunek grzybów należący do rodziny rozetkowatych (Hypocreaceae). Pasożytniczy grzyb rozwijający się na niektórych gatunkach grzybów z rodzaju mleczaj (Lactarius).
...
Po raz pierwszy zdiagnozował go w 1823 r. Elias Fries, nadając mu nazwę Sphaeria lateritia. Obecną, uznaną przez Index Fungorum nazwę nadali mu w 1860 r. Louis René Tulasne i Charles Tulasne. Synonimy:
...
Mleczaje atakuje także inny, spokrewniony gatunek – podgrzybnia gołąbkowa (Hypomyces lactifluorum). Zaatakowane przez niego grzyby uważa się za smaczne i jadalne.
