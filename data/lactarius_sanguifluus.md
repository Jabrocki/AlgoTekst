...
source: https://www.ekologia.pl/grzyby/mleczaj-czerwieniejacy/
---
...
## Kapelusz
- 6-12 cm średnicy, wypukły, ale wcześnie rozpostarty i zwykle z wklęśnięciem w części środkowej, barwy brudnołososiowej do łososiowepomarańczowej, zwłaszcza w obrębie pręg, które występują w liczbie do sześciu i są poprzerywane, często zielone; powierzchnia gładka, ze srebrzystym połyskiem, na wilgotno gładka, a na brzegu kapelusza oszroniona.
Blaszki
- mieszane, gęste, ostre na obu końcach, jasnoochrowe do pomarańczowych z odcieniem winnoczerwonym, stopniowo stają się szaro-brązowawo-winne, a wmiejscach dotkniętych nabiegają na zielono, są przyrośnięto-zbiegające.

## Trzon
- 5-6x1,5-2,5 cm, równogruby, ale u podstawy trochę zwężony, znacznie jaśniejszy od kapelusza, biało oszroniony, gładki, czasem z małymi jamkami; miejscami może słabo zielenieć.
Miąższ
- kruchy, jasny, brudno-żółto-biały, w części peryferyjnej przebarwiający się na ciemno winny, o słabym owocowym zapachu.
Mleczko
- początkowo obfite, od pierwszej chwili winnoczerwone z odcieniem lila, przy próbie na ostrość pozostawia na języku słaby gorzki posmak.
Wysyp zarodników
- jasnoochrowy, zarodniki szerokoowalne.

## Występowanie
- na nizinach i w niższych położeniach górskich przede wszystkim w południowej Europie oraz w jej środkowej cieplejszej części. Znajdowany pod sosnami na glebach wapiennych, nieraz w sąsiedztwie L. deliciosus. VII.
Zastosowanie
- jadalny.
Możliwość popełnienia pomyłki
- pokrewne gatunki mleczajów o pomarańczowo zabarwionym soku.
Literatura
...
latin_name: lactarius sanguifluus
polish_name: Mleczaj czerwieniejący
source: https://pl.wikipedia.org/wiki/Mleczaj_czerwieniejący
---
# Mleczaj czerwieniejący 
# lactarius sanguifluus 

Mleczaj czerwieniejący (Lactarius sanguifluus (Paulet) Fr.) – gatunek grzybów z rodziny gołąbkowatych (Russulaceae).
...
Po raz pierwszy opisał go w 1793 r. Jean-Jacques Paulet, nadając mu nazwę Hypophyllum sanguifluum. Obecną, uznaną przez Index Fungorum nazwę, nadał mu w 1838 r. Elias Fries, przenosząc go do rodzaju Lactarius. Niektóre synonimy naukowe:

Nazwę polską podała Alina Skirgiełło w 1998 r.

## Morfologia 

Średnica 5–12 cm, za młodu łukowaty z podwiniętym brzegiem i wgłębionym środkiem, potem staje się spłaszczony, i płatowato pofalowany. Nie posiada garbka. Skórka gładka, jasnopomarańczowa z koncentrycznymi brązowoczerwonymi wybarwieniami w postaci krążków. Podczas wilgotnej pogody jest nieco lepka.

Dość gęste, szeroko przyrośnięte i nieco zbiegające po trzonie. U młodych okazów są bladoochrowe, u starszych czerwonawe. Po zgnieceniu zmieniają kolor; najpierw na winnoczerwony, później brudnozielony.

Wysokość 3–6 cm, grubość do 3 cm. Jest walcowaty, wyraźnie krótki i ma cieńszą podstawę. Początkowo jest pełny i twardy, później pusty i kruchy. Kolor mięsnoczerwony z fioletowym odcieniem, ochrowymi brodawkami, Po zgnieceniu zmienia kolor na zielony.

Gruby, białożółtawy, u młodych okazów twardy, u starszych kruchy. Ma korzenny smak i owocowy zapach. Po uszkodzeniu zmienia kolor na krwistoczerwony, później brudnozielony. Wydziela krwistoczerwone mleczko.

Początkowo wypływa obficie. Od samego początku jest winnoczerwone z liliowym odcieniem. W smaku jest ostre.

Wysyp zarodników jasnoochrowy. Zarodniki szerokoowalne o rozmiarach 7,1–9,1 × 6–7,5 μm. Na powierzchni posiadają dość duże brodawki połączone regularną siateczką o różnej wielkości oczkach. Podstawki mają rozmiar 40–45 × 4,5–7 μm. Wąskowrzecionowate cystydy mają rozmiar 45–55 × 4,5–7 μm i wystają prawie na 10 μm ponad hymenium.
...
Występuje w Ameryce Północnej, Europie i w Izraelu. W Polsce jego rozprzestrzenienie i częstość występowania nie są znane. W piśmiennictwie naukowym do 2003 r. opisano tylko dwa jego stanowiska.

Naziemny grzyb mykoryzowy. Występuje późnym latem i jesienią, głównie w lasach iglastych, wyłącznie pod sosnami, głównie na podłożu wapiennym.

## Znaczenie 

Grzyb jadalny. Nadaje się do pieczenia i konserwowania. W przeciwieństwie do mleczaja rydza nie powoduje barwienia moczu na czerwono.

Jest często atakowany przez pasożytniczego grzyba Hypomyces lateritius, powodującego biały nalot i niedorozwój jego blaszek oraz stwardnienie miąższu. Porażone przez tego grzyba owocniki są niejadalne.
